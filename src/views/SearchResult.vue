		...
		<PageContainer class="flex-col">
			...
			<div class="flex-col max-w-md place-self-center mt-8 mb-24 w-full flex md:max-w-2xl">
				...
				<div
					...
					v-for="i in 10"
				>
					<div class="pt-2 md:pt-0 grow"><router-link to="/blog/1">
						...
						</div><span class="mb-4 md:mr-4 max-w-xs md:max-w-sm lg:max-w-md xl:max-w-lg mt-2 block text-slate-800 text-sm">
