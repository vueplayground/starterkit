		...
		<WrapperPage class="flex-col">
			...
			<div class="flex-col max-w-md place-self-center mt-8 mb-24 w-full flex md:max-w-2xl">
				...
				<div
					...
					v-for="i in 10"
				>
					<div class="pt-2 md:pt-0 grow"><router-link to="/products/1">
							...
							8 Sales • 13 days ago
						</span> <span class="mb-4 md:mr-4 max-w-xs md:max-w-sm lg:max-w-md xl:max-w-lg mt-2 block text-slate-800 text-sm">
						...
						</span><button class="hover:bg-pink-700 py-1.5 px-4 rounded-md bg-pink-600 text-white mb-4">
							Add to Cart
						</button> </div><router-link
						to="/products/1"
						class="flex-row-reverse w-40 aspect-square max-w-full"
					><img
							...
							class="rounded-lg object-cover aspect-square w-full mb-4"
						/></router-link>
