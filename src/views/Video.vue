<template>
	<Default>
		<PageContainer class="flex-col">
			<div class="mb-32 flex mt-8 flex-col lg:flex-row mx-6 x:mx-0">
				<div class="lg:mr-6 grow">
					<div class="from-fuchsia-950 bg-gradient-to-tl bg-slate-800 rounded-md aspect-video">
					</div>
					<h2 class="overflow-hidden w-full text-ellipsis whitespace-nowrap text-2xl font-medium mt-6 mb-10">
						Lorem ipsum dolor sit amet, consectetur adipiscing elit.
					</h2>
				</div>
				<div class="w-full lg:w-96">
					<div
						class="flex-row flex mb-4 max-w-full"
						v-for="i in 10"
					><img
							...
							width="100"
							height="100"
							class="rounded-md grow object-cover aspect-video"
						/>
						<div class="w-1/2 md:w-2/3 lg:w-56 ml-2">
							<h2 class="overflow-hidden w-full text-ellipsis whitespace-nowrap text-lg font-medium">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit.
							</h2>
							...
							</div><span class="text-slate-800 text-sm">
